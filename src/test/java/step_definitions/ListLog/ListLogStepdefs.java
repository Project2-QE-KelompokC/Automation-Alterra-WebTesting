...
public class ListLogStepdefs {
    ...
    public void userInputFeedback(String feedback) throws InterruptedException {
        WebElement a = webDriver.findElement(By.xpath("//textarea[@class='textarea textarea-bordered textarea-xs w-full max-w-xs']"));
        a.sendKeys(feedback);
        Thread.sleep(2000);
    }
    ...
    public void userClickSaveButtom() throws InterruptedException {
        WebElement a = webDriver.findElement(By.xpath("//button[.='Save']"));
        a.click();
        Thread.sleep(2000);
    }

    @And("^Appear new title \"([^\"]*)\"$")
    public void appearNewTitle(String newTitle) throws InterruptedException {
        WebElement a = webDriver.findElement(By.xpath("//p[text()='"+newTitle+"']"));
        a.isDisplayed();
